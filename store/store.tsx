...
export const useCartStore = create<Store>()(
  persist(
    (set, get) => ({
      // cart: (localStorage.getItem('cart-storage') != null) ? JSON.parse(localStorage.getItem('cart-storage')!) : [],
      cart: (localStorage.getItem('cart-storage') != null) ? JSON.parse(localStorage.getItem('cart-storage')!)?.state?.cart || [] : [],
      reviews: { average: 4, totalCount: 117 },
      addToCart: (item: GuitarShop) => {
        set((state) => {
          //  validamos si esta en el carrito
